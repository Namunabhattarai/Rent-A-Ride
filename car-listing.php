  ...
  <section class="w3l-breadcrumb">
    <div class="container">
      <ul class="breadcrumbs-custom-path">
        ...
        <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Car-listing</li>
      </ul>
    </div>
  </section>
  <!--//inner-page-->
                ...
                <div class="container">
                    <div class="inventory-meta-wrap mb-50">
                            <div class="section-title title-left text-center text-lg-left m-3">
                                <h3 class="top-sep text-center text-white">SELECT YOUR FAVOURITE CARS</h3>
                            </div>
                        <div class="row align-items-center">
                            ...
                            <form class="form-inline" method="post" action="search.php">
                                  <div class="input-group">
                                    <input type="text" class="form-control" id="search" name="search" size="50" placeholder="SEARCH FOR YOUR FAVOURITE CARS" required>  
                                  </div>
                             </form><br>
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-9">
                            ...
                            <div class="inventory-list-item">
                                ...
                                <div class="inventory-list-content">
                                    ...
                                    <h4><a href="inventory-details-cars.php?itemno=<?php echo $row['car_id']; ?>"><?php echo $row['name'];?></a></h4>
