              ...
              <div class="banner-info">
                <div class="container">
                  ...
                  <div class="banner-info-bg">
                    <h6>We Provide the best Rental services.</h6>
                    <h5>We are experienced and expert Rental company. </h5>
                    ...
                    <a class="btn btn-style btn-outline-light mt-sm-5 mt-4" href="about.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="popular-selling-ad-banner">
                                <a href="#"><img src="img/images/popular_selling_banner.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6">
                            <div class="section-title text-center mb-35">
                                ...
                                <span class="sub-title">our Featured Bikes/Cars</span>
                                <h2 class="title">latest  Bikes/Cars for rent</h2><br>
                                <form class="form-inline" method="post" action="search.php">
                                  <div class="input-group">
                                    <input type="text" class="form-control" id="search" name="search" size="50" placeholder="Search Here" required>
                    ...
                    <div class="latest-cars-wrapper">
                        <div class="row latest-car-items-active">
                            <?php
                                include('config.php');
                                $query = "SELECT * FROM car_list LIMIT 3";
                         ...
                         <div class="row latest-car-items-active">
                            <?php
                                include('config.php');
                                $query = "SELECT * FROM bike_list LIMIT 3 OFFSET 2";
                                $query_run = mysqli_query($connection, $query);
                                if(mysqli_num_rows($query_run) > 0)        
                                {
                                    while($row = mysqli_fetch_assoc($query_run))
                    ...
                    <div class="row">
                            <div class="col-12">
                                <div class="latest-car-btn text-center mt-10">
                                    <a href="all-show.php" class="btn">SHOW ALL</a>
                                </div>
                            </div>
                        </div>
                </div>
